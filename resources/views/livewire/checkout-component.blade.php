			...
			<div  class="col-md-12">
                <div class="wrap-address-billing">
					...
					<p class="row-in-form">
						...
						<p class="row-in-form">
							<label for="add">province:</label>
							<input  type="text" name="add" value="" placeholder="province" wire:model="s_province">
			...
			<div class="summary summary-checkout">
					<div class="summary-item payment-method">
						...
						<p class="row-in-form">
							...
							<input  type="text" name="card-no" value="" placeholder="car number" wire:model="card_no">
							@error('card_no') <span class="text-danger">{{$message}}</span>  @enderror
						</p>
						<p class="row-in-form">
							<label for="exp-month">Expiry Month:</label>
							<input  type="text" name="exp-mont" value="" placeholder="MM" wire:model="exp_month">
						...
						<p class="row-in-form">
							...
							<input  type="password" name="cvc" value="" placeholder="cvc number" wire:model="cvc" style=" font-size: 13px;line-height: 19px;display: inline-block;height: 43px;padding: 2px 20px;max-width: 300px; width: 100%; border: 1px solid #e6e6e6;">
						...
						<div class="choose-payment-methods">
							...
							<label class="payment-method">
								...
								<span>Debit / CreditCard Payment</span>
