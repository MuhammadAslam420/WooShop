				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					<div class="wrap-product-detail">
						<div class="detail-media">
							<div class="product-gallery" wire:ignore>
							  <ul class="slides">
							    ...
							    <li data-thumb="{{asset('assets/images/shoes')}}/{{$product->image}}">
							    	<img src="{{asset('assets/images/shoes')}}/{{$product->image}}" alt="{{$product->name}}" />
							    </li>
								...
								@if($image)
								<li data-thumb="{{asset('assets/images/shoes')}}/{{$image}}">
							    	<img src="{{asset('assets/images/shoes')}}/{{$image}}" alt="product thumbnail" />
							    </li>
								@endif
								@endforeach
						...
						<div class="detail-info">
							...
							<div class="wrap-price"><span class="product-price" style="color:red; font-size:15px;padding-left:5px;">{{$product->sale_price}}</span>
						<del>
							<span class="product-price regprice"  style="color:black; font-size:12px; text-decoration:line-through;">{{$product->regular_price}}</span>
						</del></div>
							@else
                                   ...
                                   <div class="product product-widget-style">
                                       <div class="thumbnnail">
                                           <a href="{{route('product.details',['slug'=>$popular_product->slug])}}" title="{{$popular_product->name}}">
                                               <figure><img src="{{asset('assets/images/shoes')}}/{{$popular_product->image}}" style="height:100px;"></figure>
                                           </a>
                                       </div>
                                ...
                                <div class="product product-style-2 equal-elem ">
									<div class="product-thumnail">
										<a href="{{route('product.details',['slug'=>$related_product->slug])}}" title="{{$related_product->name}}">
											<figure><img src="{{asset('assets/images/shoes')}}/{{$related_product->image}}" style="width:214px; height:214px;" alt="{{$related_product->name}}"></figure>
										</a>
