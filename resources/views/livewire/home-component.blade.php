<main id="main">
		<div class="container">
			...
			<div class="wrap-show-advance-info-box style-1 has-countdown">
				...
				<div class="wrap-countdown mercado-countdown" data-expire="{{ Carbon\Carbon::parse($sale->sale_date)->format('Y/m/d h:m:s')}}" style="color:black;">{{Carbon\Carbon::parse($sale->sale_date)->format('Y/m/d h:m:s')}}</div>
					...
					<div class="product product-style-2 equal-elem ">
						<div class="product-thumnail">
							<a href="{{route('product.details',['slug'=>$sproduct->slug])}}" title="{{$sproduct->name}}">
								<figure><img src="{{asset('assets/images/shoes')}}/{{$sproduct->image}}" width="800" height="800" alt="{{$sproduct->name}}"></figure>
							</a>
						...
						<div class="product-info">
							...
							<div class="wrap-price"><ins><p class="product-price">Rs.{{$sproduct->sale_price}}</p><del><p class="product-price">Rs.{{$sproduct->regular_price}}</p></del></ins></div>
						</div>
					</div>
					@endforeach
			...
			<div class="wrap-show-advance-info-box style-1">
				...
				<div class="wrap-top-banner">
					<a href="#" class="link-banner banner-effect-2">
						<figure><img src="{{asset('assets/images/shoes/shoe-img41.jpg')}}" width="1170" style="height:240px;" alt=""></figure>
					</a>
				</div>
									...
									<div class="product product-style-2 equal-elem ">
										<div class="product-thumnail">
											<a href="{{route('product.details',['slug'=>$lproduct->slug])}}" title="{{$lproduct->name}}">
												<figure><img src="{{asset('assets/images/shoes')}}/{{$lproduct->image}}" width="800" height="800" alt="{{$lproduct->name}}"></figure>
											</a>
											<div class="group-flash">
								...
								<div class="product product-style-2 equal-elem ">
										<div class="product-thumnail">
											<a href="{{route('product.details',['slug'=>$product->slug])}}" title="{{$product->name}}">
												<figure><img src="{{asset('assets/images/shoes')}}/{{$product->image}}" width="800" height="800" alt="{{$product->name}}"></figure>
											</a>
										...
										<div class="product-info">
											...
											<div class="wrap-price"><ins><p class="product-price">Rs.{{$product->regular_price}}</p></ins> <del><p class="product-price">$250.00</p></del></div>
										</div>
									</div>
									@endforeach	
