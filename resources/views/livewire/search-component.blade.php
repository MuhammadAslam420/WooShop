		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><span>Shoes</span></li>
				</ul>
			</div>
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
								...
								<div class="product product-style-3 equal-elem ">
									<div class="product-thumnail">
										<a href="{{route('product.details',['slug'=>$product->slug])}}" title="{{$product->name}}">
											<figure><img src="{{asset('assets/images/shoes')}}/{{$product->image}}" alt="{{$product->name}}" style="height:210px; width:210px;"></figure>
										</a>
									</div>
                    ...
                    @else
                    <p class="alert alert-warning">Ops No Products found</p>
                    @endif
