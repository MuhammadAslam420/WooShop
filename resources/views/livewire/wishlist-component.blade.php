		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><span>Stylish Shoes Wishlist</span></li>
				</ul>
			</div>
            <style>
	.product-wish{
		...
		color:#ff7007 !important;
            ...
            <div class="row">
                @if(Cart::instance('wishlist')->content()->count()>0)
								...
								<div class="product product-style-3 equal-elem ">
									<div class="product-thumnail">
										<a href="{{route('product.details',['slug'=>$item->model->slug])}}" title="{{$item->model->name}}">
											<figure><img src="{{asset('assets/images/shoes')}}/{{$item->model->image}}" alt="{{$item->model->name}}" style="height:210px; width:210px;"></figure>
										</a>
									</div>
                        ...
                        @else
						<h4 class="text-danger">No Product in your wishlist!.</h4>
                        @endif
					...
					<div class="d-flex justify-content-center" style="color:black;">
						...
						<p class="result-count">Showing 1-12 of 12 result</p>
					</div>
				</div>
</div>
</main>